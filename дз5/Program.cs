...
// нечетная позиция с т.з. программирования (отсчет начинается с 0, т.е. индекс) или с т.з. обычного пользователя (начинается с 1)?
// решение сделано для отсчета с 1
